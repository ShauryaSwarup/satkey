            ...
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24 items-center">
                ...
                <div className="relative flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 md:space-y-8 animate-fade-in order-2 lg:order-1">
                    ...
                    <h1 className="text-5xl sm:text-7xl md:text-8xl lg:text-[120px] font-bold text-transparent tracking-tight leading-[0.9]">
                        <span className="bg-clip-text bg-linear-to-b from-orange-200 to-orange-400">Sat</span>
                        <span className="bg-clip-text bg-linear-to-b from-white to-white/40"> Key</span>
                    </h1>

                    <p className="max-w-xl text-base md:text-lg lg:text-xl text-white/60 font-light leading-relaxed">
                        The future of <span className="text-orange-400 font-medium">BTCFi</span> is here. One click staking for <span className="text-orange-400 font-medium">Bitcoin</span> in <span className="text-[#ecf1f2] font-medium">Stark</span><span className="text-[#d87a8b] font-medium">net</span>.
                    </p>

                    <div className="pt-2 md:pt-4 pointer-events-auto">
                        <button className="group relative inline-flex items-center gap-3 px-6 md:px-8 py-3 md:py-4 bg-white/10 backdrop-blur-md text-white rounded-full border border-white/20 font-semibold tracking-wide overflow-hidden transition-all duration-300 hover:bg-white/20 hover:scale-105 active:scale-95 text-sm md:text-base hover:cursor-pointer">
                            <span className="relative z-10">Put your <span className="text-orange-400">₿</span> to work</span>
